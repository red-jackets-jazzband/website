...
<div id="sheetmenu" class="hideOnprint">
  ...
  <div class="sheet-actions" id="sheetActions">
    <button id="editModeBtn" class="sheet-icon-btn" type="button" title="Edit mode" aria-label="Toggle edit mode" aria-pressed="false"><span class="fa-solid fa-pencil" aria-hidden="true"></span></button>
  ...
  <dialog id="mixerPanel" class="mixer-panel" aria-label="Mixer">
    ...
    <!-- Populated by songs/mixer.js's syncVoices/rebuildVoiceStrips — one
         strip per the tune's resolved voice (lib/audio-mix.js's
         resolveMixerVoices): an ordinary tune's own Melody, a chart's own
         named staves (Trumpet + Sousaphone, ...), plus Comping appended when
         it's on. Always at least one strip once a song is open; see
         mixer.js's own doc comment. -->
    <div id="mixerVoicesSection" class="mixer-voices-section">
    ...
    <div class="mixer-strip mixer-strip--swing" id="mixerStripSwing">
      <span class="mixer-swatch mixer-swatch--swing" aria-hidden="true"></span>
    ...
    <div class="mixer-strip mixer-strip--toggles">
      ...
      <div class="mixer-toggle-item" id="mixerStripQuality">
        ...
        <span class="mixer-strip-label">High quality</span>
...
<div id="editPopover" class="rj-edit-popover hideOnprint" hidden>
  <div class="rj-edit-popover-body" id="editPopoverBody"></div>
</div>
