...
<div id="rjLibrary" class="rj-library hideOnprint">
  <div class="rj-library-tabs" id="libraryTabs">
    ...
    <button type="button" id="offlineBtn" class="rj-library-help-btn" title="Download for offline"><span class="fa-solid fa-cloud-arrow-down" aria-hidden="true"></span></button>
  </div>
  <div id="offlineStatus" class="rj-offline-status" hidden></div>
  ...
  <dialog id="mixerPanel" class="mixer-panel" aria-label="Mixer">
    ...
    <div class="mixer-strip mixer-strip--swing" id="mixerStripSwing">
      ...
      <div class="mixer-fader-track">
        ...
        <input type="range" id="mixerSwingRange" min="0" max="100" value="40" aria-label="Swing amount">
      </div>
      <span class="mixer-readout" id="mixerSwingReadout">40%</span>
