...
<div id="inspirationPanel" class="inspiration-panel hideOnprint" hidden>
  ...
  <div class="inspiration-loop" id="inspirationLoopBar" hidden>
    ...
    <div class="inspiration-loop-controls">
      <div class="inspiration-loop-transport">
      ...
      <div class="inspiration-loop-stepper" id="inspirationLoopZoom" title="Timeline zoom">
        <button type="button" class="inspiration-loop-stepper-btn" id="inspirationZoomOut" aria-label="Zoom out" disabled><span class="fa-solid fa-magnifying-glass-minus" aria-hidden="true"></span></button>
        <div class="inspiration-loop-stepper-value">
          <span id="inspirationZoomValue">1&times;</span>
          <span class="inspiration-loop-stepper-label">zoom</span>
        </div>
        <button type="button" class="inspiration-loop-stepper-btn" id="inspirationZoomIn" aria-label="Zoom in"><span class="fa-solid fa-magnifying-glass-plus" aria-hidden="true"></span></button>
      </div>
