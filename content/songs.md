...
<div id="sheetmenu" class="hideOnprint">
  ...
  <div class="sheet-transport">
    ...
    <button id="mixerBtn" class="sheet-icon-btn" type="button" disabled title="Mixer" aria-label="Mixer" aria-haspopup="true" aria-expanded="false"><span class="fa-solid fa-sliders" aria-hidden="true"></span></button>
  </div>
  ...
  <div id="mixerPanel" class="mixer-panel" role="dialog" aria-label="Mixer" hidden>
    ...
    <div class="mixer-strip" id="mixerStripMelody">
      ...
      <div class="mixer-fader-track">
        ...
        <input type="range" id="mixerMelodyRange" min="0" max="100" value="100" aria-label="Melody volume">
      </div>
